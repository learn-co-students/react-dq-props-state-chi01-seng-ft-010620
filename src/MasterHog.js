    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor={this.state.eyeColor} pigDetails={offspring[0]}/>
          <BabyHog eyeColor={this.state.eyeColor} pigDetails={offspring[1]}/>
          <BabyHog eyeColor={this.state.eyeColor} pigDetails={offspring[2]}/>
        </ul>
